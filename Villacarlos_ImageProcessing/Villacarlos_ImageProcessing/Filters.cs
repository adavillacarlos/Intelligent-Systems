...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
		...
		//This uses a pointer that points to each pixels 
		public static bool GrayScale(Bitmap b) 
		{
			// GDI+ still lies to us - the return format is BGR, NOT RGB.
			BitmapData bmData = b.LockBits(new Rectangle(0, 0, b.Width, b.Height), ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb); //lock the image in a 24 bit

			//skipping the offsets
			int stride = bmData.Stride;
			System.IntPtr Scan0 = bmData.Scan0;

			unsafe //pointers are unsafe
			{
				byte * p = (byte *)(void *)Scan0; 

				int nOffset = stride - b.Width*3;

				byte red, green, blue; //each pixel if BGR 
