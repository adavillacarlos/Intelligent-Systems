...
//Class that sends Messages to the DLL

namespace WebCamLib
{
    public class Device
    {
        //Constant Values to be call a specific functions 
        private const short WM_CAP = 0x400;
        private const int WM_CAP_DRIVER_CONNECT = 0x40a;
        private const int WM_CAP_DRIVER_DISCONNECT = 0x40b;
        private const int WM_CAP_EDIT_COPY = WM_CAP + 30; //Printscreen
        private const int WM_CAP_SET_PREVIEW = 0x432; //What was shown in the camera
        ...
        /// <summary>
        /// To Initialize the device to display the preview of the camera 
        /// </summary>
